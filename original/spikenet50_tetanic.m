function spikenet50_tetanic(folder)
% Runs an integerate and fire neural network model.
% Displays correlograms and spike triggered averages for selected units.
%
% This version has been setup for tetanic conditioning. This is a
% modification of spikenet50.m with:
%   p.conditioning_type = 5;   % Tetanic stimulation: 4 = Column A, 5 = Column B, 6 = Colunm C
% Notable parameters:
%   p.tetanic_freq = 10;       % Max stims/sec for exponentially distributed tetanic conditioning 
%   p.stim_refractory_ms = 10; % Note tthat increased refractory period will reduce the actual stimulation frequency.
...
p.conditioning_type = 5;       % 0=No conditioning, 1=spike triggered, 2=paired pulse, 3 = cycle triggered on LFPB, 4 = Tetanic stim on Col A, 5 = Tetanic stim on Col B, 6 = Tetatic stim on Col C, 7 = EMG triggered Stimulation, 8 = Gamma triggered stimulation, 9 = Activity triggered stimulation
